...
== Description ==
WooCommerce alipay payment gateway,Support alipay payment through scan QR code Support In-App Payment , Don't need alipay certification,Don't need the domain name registration.(此插件适合无法开通支付宝即时到帐的用户使用,免签约免备案。已有企业支付宝的用户不适合。)
...
3. Activate.
4. Bound to personal WeChat account
5. bulid a new application get appid and key put in plugin 
6. If the main currency of your store is not Chinese Yuan, please also set the exchange rate so that alipay can convert the price to Chinese Yuan.
